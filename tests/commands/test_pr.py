...
def test_pr_flow_yes_comma_separated(mock_config, mock_git_utils, mock_llm, mock_github, mock_open):
...
def test_pr_flow_milestone(mock_config, mock_git_utils, mock_llm, mock_github, mock_open):
